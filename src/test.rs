...
fn test_binop() {
    ...
    let res = parser::parse_symbol(&mut stack, "+");
    let expected_res = Ok(());
...
fn test_if() {
    ...
    let res = parser::parse_symbol(&mut stack, "if");
    let expected_res = Ok(());
...
fn test_lookup() {
    ...
    let res = parser::parse_symbol(&mut stack, "sdfjhsdjklfdskjhf"); // definitely invalid token
